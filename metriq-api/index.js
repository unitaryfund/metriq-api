...
const publicApiRoutes = ['/api/login', '/api/register', '/api/recover', '/api/password', '/api/tag', '/api/platform', '/api/property', '/api/dataType', '/api/v1/arxiv_id', '/api/user/topSubmitters']
